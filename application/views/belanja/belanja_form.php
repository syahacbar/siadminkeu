		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                 <div class="panel-heading">INPUT DATA BELANJA</div>
...
<table class='table'> 
	    ...
	    <tr><td width='200'>Pc (Buah)<?php echo form_error('pc') ?></td><td><input type="number" class="form-control " name="pc" id="pc" placeholder="Pc" value="<?php echo $pc; ?>" /></td></tr>
	    <tr><td width='200'>Waktu (Jam)<?php echo form_error('waktu') ?></td><td><input type="number" class="form-control " name="waktu" id="waktu" placeholder="Waktu" value="<?php echo $waktu; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_belanja" value="<?php echo $id_belanja; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('belanja') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>