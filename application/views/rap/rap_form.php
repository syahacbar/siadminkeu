		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                 <div class="panel-heading">INPUT DATA RAP</div>
...
<table class='table'> 
	    ...
	    <tr><td width='200'>Lokasi Kegiatan <?php echo form_error('lokasi_kegiatan') ?></td><td><input type="text" class="form-control" name="lokasi_kegiatan" id="lokasi_kegiatan" placeholder="Lokasi Kegiatan" value="<?php echo $lokasi_kegiatan; ?>" /></td></tr>
	    <tr><td width='200'>Target Kegiatan <?php echo form_error('target_kegiatan') ?></td><td><input type="text" class="form-control" name="target_kegiatan" id="target_kegiatan" placeholder="Target Kegiatan" value="<?php echo $target_kegiatan; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_rap" value="<?php echo $id_rap; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('rap') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>